...
import CourseInformationForm from './CourseInfomation/CourseInformationForm'
import CourseBuilderForm from './CourseBuilder/CourseBuilderForm'
import PublishCourse from './PublishCourse/PublishCourse'

export default function RenderSteps(){
    const {step} = useSelector( (state) => state.course);    
    // new course will be add in three steps --> 
    const steps = [
        {
            id: 1,
  ...
  return (
    <>  
        ...
        <div className='relative mb-2 flex w-full justify-center '>
           {
            steps.map( (item ) => (
                <>
                  ...
                  {/* when the id is above the steps length */}
                  {/* border dashed code ---> */}
        ...
        {/* render specific component on the basics of step */}
