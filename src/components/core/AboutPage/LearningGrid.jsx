            ...
            LearningGridArray.map( (card , index ) => {
                return(
                    <div key={index} className={`${ index === 0 && "xl:col-span-2 xl:h-[294px]"}
                               ${ card.order % 2 === 0 && "bg-richblack-700 h-[294px]"}
                               ${ card.order % 2 ===1 && "bg-richblack-800 h-[294px] " }
                               ${ card.order === 3 && "xl:col-start-2"}`
                    } >
                        {
                            card.order < 0 ? (
                                <div className='xl:w-[90%] flex flex-col gap-y-4'>
                                    <div className='text-4xl font-[600]'>
                                        {card.heading}
                                        <HighlightText text={card.highliteText}/>
                                    </div>
                                    <p className='text-richblack-300 font-[300]'>{card.description}</p>
                                ...
                                <div className='flex flex-col gap-8 p-8'>
                                    <h1 className='text-richblack-5 text-lg font-[400]'>{card.heading}</h1>
                                    <p className='text-richblack-300 font-[200]'>{card.description}</p>
                                </div>
                            )
                        }
                    </div>
